...
- Включай больше примеров и кейсов из российской жизни
...
"""
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system", 
                        "content": """Ты опытный психолог и писатель, специализирующийся на создании ОЧЕНЬ ДЛИННЫХ и детальных статей для российской и белорусской аудитории. 
...
- Включи конкретные примеры из российской жизни
...
"""
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system", 
                        "content": "Ты опытный психолог, который расширяет статьи, добавляя больше деталей и практических советов."
                    },
...
"""
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system", 
                        "content": "Ты опытный психолог, который создает детальные планы статей для российской аудитории."
                    },
...
- Включи примеры из российской жизни
...
"""
                ...
                response = self.client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system", 
                            "content": "Ты опытный психолог, который пишет детальные разделы статей для российской аудитории."
                        },
