...
if (!$is_github_actions && !$is_local_test) {
...
try {
    ...
    if ($existing) {
        ...
        $stmt->execute([
            $title, $content, $excerpt, $author, $tagsValue,
            $categoryId, $featuredImage, $metaTitle, $metaDescription, $slug
        ]);
        ...
        $stmt = $pdo->prepare($sql);
        $stmt->execute([
            $title, $content, $excerpt, $author, $tagsValue, $slug,
            $categoryId, $featuredImage, $metaTitle, $metaDescription
        ]);
