...
🎯 **ОБЪЕМ:** МИНИМУМ 15,000 символов (без пробелов), лучше 18,000+
🎯 **СТРУКТУРА:** HTML с заголовками h1, h2, h3, параграфами p, списками ul/li
🎯 **СТИЛЬ:** Живой, эмпатичный, без канцелярита

📖 **СОДЕРЖАНИЕ:**
- Начни с эмоционального крючка (реальная история из российской жизни, 4-6 абзацев)
- Раскрой проблему через призму российского менталитета (3-4 абзаца)
- Покажи, что это нормально и с этим можно справиться
- Дай конкретные, выполнимые советы (5-7 техник с подробным описанием)
- Включи то, о чем обычно молчат психологи (3-4 провокационные мысли)
- Заверши мотивирующим призывом к действию

📝 **ДЕТАЛЬНЫЕ ТРЕБОВАНИЯ:**
- Каждый раздел: минимум 3-4 абзаца
- Включи диалоги (3-4 реплики) и внутренние монологи
- Конкретные примеры: имена, возрасты, профессии
- Объясни "почему это работает" на уровне психики/мозга
- Временные рамки: "через неделю...", "через месяц..."
- Абзацы короткие: 2-3 предложения, максимум 4 строки
