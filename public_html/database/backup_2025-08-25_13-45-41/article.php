        ...
        <div class="wrapper">
            <div class="article-layout">
                ...
                <div class="article-main">
                    ...
                    <!-- Краткое описание -->
                    <p class="article-excerpt"><?= e($articleData['excerpt']) ?></p>
                ...
                <aside class="article-sidebar">
                    ...
                    <div class="sidebar-block consultation-block">
                        ...
                        <p>Первая консультация всего <strong>1000 рублей</strong> или <strong>15 минут
                                бесплатно</strong></p>
                        <button class="consultation-btn" data-popup="consultation-popup"
                            data-form-source="Нужна консультация специалиста? первая консультация 1000 рублей (страница статей)">
                    ...
                    <div class="sidebar-block telegram-block">
                        ...
                        <a href="https://t.me/taterapia" target="_blank" class="telegram-btn">
                    ...
                    <div class="sidebar-block promo-block">
                        ...
                        <p>Здесь будет промо-информация из админки</p>
                        <div class="promo-content">
                            <p>🎉 <strong>Скидка 20%</strong> на первую консультацию при записи через сайт!</p>
                        </div>
                    </div>
                </aside>
            </div>
    ...
    <section class="comments-section">
        <div class="wrapper">
            ...
            <div class="comments-container">
                <!-- Здесь будет форма добавления комментария и список комментариев -->
                <div class="comments-placeholder">
                    <p>Функция комментариев будет добавлена позже</p>
                </div>
            </div>
        </div>
    </section>
